...
namespace NearIT
{
	...
	[BaseType (typeof(NSObject))]
	interface NITReaction : INativeObject
    {
	...
	[BaseType (typeof(NSObject))]
	interface NITCooldownValidator : NITValidating
	{
	...
	partial interface Constants
	{
		// extern NSString *const _Nonnull NITCustomTriggerPluginName;
		[Field ("NITCustomTriggerPluginName", "__Internal")]
		NSString NITCustomTriggerPluginName { get; }

		// extern NSString *const _Nonnull NITCustomTriggerAction;
		[Field ("NITCustomTriggerAction", "__Internal")]
		NSString NITCustomTriggerAction { get; }

		// extern NSString *const _Nonnull NITCustomTriggerMetadata;
		[Field ("NITCustomTriggerMetadata", "__Internal")]
		NSString NITCustomTriggerMetadata { get; }
	}
	...
	{
		// +(NITTriggerRequest * _Nonnull)buildTriggerRequestWithKey:(NSString * _Nonnull)key;
		[Static]
		[Export ("buildTriggerRequestWithKey:")]
		NITTriggerRequest BuildTriggerRequestWithKey (string key);
	}

	// @interface NITDataPoint : NITResource <NSCoding>
	[BaseType (typeof(NITResource))]
	interface NITDataPoint : INSCoding
	{
	...
	[BaseType (typeof(NSObject))]
	interface NITDefaultLogger : NITLogger
	{
	}
	...
	interface NITEnrollDeviceViewController
	{
		...
		// -(instancetype _Nonnull)initWithInstallation:(NITInstallation * _Nonnull)installation configuration:(NITConfiguration * _Nonnull)configuration geopolisState:(NITGeopolisState * _Nonnull)geopolisState;
		[Export ("initWithInstallation:configuration:geopolisState:")]
		IntPtr Constructor (NITInstallation installation, NITConfiguration configuration, NITGeopolisState geopolisState);
	...
	interface NITManager
	{
		...
		// -(BOOL)getContentFromUserInfo:(NSDictionary * _Nonnull)userInfo completion:(void (^ _Nullable)(NITReactionBundle * _Nullable, NITTrackingInfo * _Nullable, NSError * _Nullable))completionHandler;
		[Export ("getContentFromUserInfo:completion:")]
		bool GetContentFromUserInfo (NSDictionary userInfo, [NullAllowed] Action<NITReactionBundle, NITTrackingInfo, NSError> completionHandler);
		...
		// -(BOOL)processRecipeWithUserInfo:(NSDictionary<NSString *,id> * _Nonnull)userInfo completion:(void (^ _Nullable)(NITReactionBundle * _Nullable, NITTrackingInfo * _Nullable, NSError * _Nullable))completionHandler __attribute__((deprecated("Use getContentFrom"))) __attribute__((deprecated("")));
	...
	[BaseType (typeof(NSObject))]
	interface NITRecipesManager : NITRecipesManaging
	{
	...
	interface NITGeopolisManager
	{
		...
		// @property (nonatomic, strong) NITGeopolisState * _Nonnull state;
		[Export ("state", ArgumentSemantic.Strong)]
		NITGeopolisState State { get; set; }

		// -(instancetype _Nonnull)initWithConfiguration:(NITConfiguration * _Nonnull)configuration trackManager:(NITTrackManager * _Nonnull)trackManager repository:(NITNodeRepository * _Nonnull)repository geopolisRadar:(NITGeopolisRadar * _Nonnull)radar geopolisForegroundRadar:(NITGeopolisForegroundRadar * _Nonnull)foregroundRadar locationManager:(CLLocationManager * _Nonnull)locationManager state:(NITGeopolisState * _Nonnull)state;
		[Export ("initWithConfiguration:trackManager:repository:geopolisRadar:geopolisForegroundRadar:locationManager:state:")]
		IntPtr Constructor (NITConfiguration configuration, NITTrackManager trackManager, NITNodeRepository repository, NITGeopolisRadar radar, NITGeopolisForegroundRadar foregroundRadar, CLLocationManager locationManager, NITGeopolisState state);
		...
		// -(BOOL)isRadarStarted;
		[Export ("isRadarStarted")]
		// [Verify(MethodToProperty)]
		bool IsRadarStarted { get; }
	}
	...
	interface NITGeopolisRadar
	{
		...
		[Export ("resumeLocationUpdates")]
		// [Verify(MethodToProperty)]
		bool ResumeLocationUpdates { get; }
	...
	interface NITGeopolisState
	{
		...
		// @property (nonatomic) BOOL radarStarted;
		[Export ("radarStarted")]
		bool RadarStarted { get; set; }
	...
	{
		// @property (nonatomic, strong) NITReactionItem * _Nullable reactionItem;
		[NullAllowed, Export ("reactionItem", ArgumentSemantic.Strong)]
		NITReactionItem ReactionItem { get; set; }

		// @property (nonatomic, strong) NSString * _Nullable notification;
		...
		// -(instancetype)initWithReactionItem:(NITReactionItem * _Nullable)reactionItem notification:(NSString * _Nullable)notification trackingInfo:(NITTrackingInfo * _Nonnull)trackingInfo timestamp:(NSTimeInterval)timestamp read:(BOOL)read;
		[Export ("initWithReactionItem:notification:trackingInfo:timestamp:read:")]
		IntPtr Constructor ([NullAllowed] NITReactionItem reactionItem, [NullAllowed] string notification, NITTrackingInfo trackingInfo, double timestamp, bool read);
		...
		// -(NSString * _Nullable)stringDigestWith:(NSString * _Nonnull)profileId;
		[Export ("stringDigestWith:")]
		[return: NullAllowed]
		string StringDigestWith (string profileId);
	}
	...
	{
		// -(instancetype _Nonnull)initWithItemResolver:(NITHistoryItemResolver * _Nonnull)itemResolver registry:(NITRemoteItemRegistry * _Nonnull)registry;
		[Export ("initWithItemResolver:registry:")]
		IntPtr Constructor (NITHistoryItemResolver itemResolver, NITRemoteItemRegistry registry);

		// -(BOOL)merge:(NSArray<NITRemoteItem *> * _Nonnull)remotePushes and:(NSArray<NITHistoryEntry *> * _Nonnull)local withResults:(NSArray<NITHistoryItem *> * _Nonnull * _Nonnull)results withNotificationsToDelete:(NSArray<NITHistoryEntry *> * _Nonnull * _Nonnull)toDelete;
	...
	{
		// -(instancetype _Nonnull)initWithCache:(NITCacheManager * _Nonnull)cache dateManager:(NITDateManager * _Nonnull)dateManager;
	...
	[BaseType (typeof(NSObject))]
	interface NITNetworkManager : NITNetworkManaging
	{
	...
	interface NITNetworkProvider
	{
		...
		// -(NSURLRequest * _Nonnull)getProfileWithId:(NSString * _Nonnull)profileId;
		[Export ("getProfileWithId:")]
		NSUrlRequest GetProfileWithId (string profileId);
		...
		// -(NSURLRequest * _Nonnull)optOutWithProfileId:(NSString * _Nonnull)profileId;
		[Export ("optOutWithProfileId:")]
		NSUrlRequest OptOutWithProfileId (string profileId);
	...
	interface NITNotificationHistoryManager
	{
		[Wrap ("WeakDelegate")]
		[NullAllowed]
		NITNotificationUpdateDelegate Delegate { get; set; }
		...
		[Export ("initWithDateManager:internetReachability:state:repo:")]
		IntPtr Constructor (NITDateManager dateManager, NITReachability internetReachability, NITNotificationUpdateState state, NITNotificationHistoryRepo repo);
	...
	// typedef void (^NITNotificationHistoryBlock)(NSArray<NITHistoryItem *> * _Nullable, NSError * _Nullable);
	delegate void NITNotificationHistoryBlock ([NullAllowed] NITHistoryItem[] arg0, [NullAllowed] NSError arg1);

	// @interface NITNotificationHistoryRepo : NSObject
	[BaseType (typeof(NSObject))]
	interface NITNotificationHistoryRepo
	{
		// -(instancetype _Nonnull)initWithApi:(NITHistoryApi * _Nonnull)api merger:(NITHistoryMerger * _Nonnull)merger localHistory:(NITLocalHistory * _Nonnull)localHistory;
		[Export ("initWithApi:merger:localHistory:")]
		IntPtr Constructor (NITHistoryApi api, NITHistoryMerger merger, NITLocalHistory localHistory);

		// -(NITHistoryEntry * _Nullable)findLocalEntryFromRecipeId:(NSString * _Nonnull)recipeID reactionItem:(NITReactionItem * _Nonnull)reactionItem;
		[Export ("findLocalEntryFromRecipeId:reactionItem:")]
		[return: NullAllowed]
		NITHistoryEntry FindLocalEntryFromRecipeId (string recipeID, NITReactionItem reactionItem);

		// -(void)updateEntry:(NITHistoryEntry * _Nonnull)entry read:(_Bool)read notification:(NSString * _Nonnull)notification;
		[Export ("updateEntry:read:notification:")]
		void UpdateEntry (NITHistoryEntry entry, bool read, string notification);
		...
		// -(void)fetchNotificationHistoryWithCompletion:(NITNotificationHistoryBlock _Nonnull)completion;
		[Export ("fetchNotificationHistoryWithCompletion:")]
		void FetchNotificationHistoryWithCompletion (NITNotificationHistoryBlock completion);
	}
	...
	partial interface Constants
	{
		// extern NSString *const _Nonnull NITNotificationUpdateClearedTimestampKey;
		[Field ("NITNotificationUpdateClearedTimestampKey", "__Internal")]
		NSString NITNotificationUpdateClearedTimestampKey { get; }

		// extern const NSTimeInterval NITTimeStampDefault;
		[Field ("NITTimeStampDefault", "__Internal")]
		double NITTimeStampDefault { get; }

		// extern NSString *const _Nonnull NITNotificationUpdateStateCacheKey;
		[Field ("NITNotificationUpdateStateCacheKey", "__Internal")]
		NSString NITNotificationUpdateStateCacheKey { get; }
	}

	// @interface NITNotificationUpdateState : NSObject
	[BaseType (typeof(NSObject))]
	interface NITNotificationUpdateState
	{
		// @property (nonatomic) NSTimeInterval notificationClearedTimestamp;
		[Export ("notificationClearedTimestamp")]
		double NotificationClearedTimestamp { get; set; }

		// -(instancetype _Nonnull)initWithCacheManager:(NITCacheManager * _Nonnull)cachenManager;
		[Export ("initWithCacheManager:")]
		IntPtr Constructor (NITCacheManager cachenManager);
	...
	interface NITRecipesApi
	{
		...
		// -(void)processRecipesWithCompletionHandler:(void (^ _Nonnull)(NSArray<NITRecipe *> * _Nullable, BOOL, NSNumber * _Nullable, NSError * _Nullable))completionHandler;
	...
	// @interface NITRemoteItemRegistry : NSObject
	[BaseType (typeof(NSObject))]
	interface NITRemoteItemRegistry
	{
		// -(instancetype _Nonnull)initWithConfiguration:(NITConfiguration * _Nonnull)configuration;
		[Export ("initWithConfiguration:")]
		IntPtr Constructor (NITConfiguration configuration);

		// -(void)setItems:(NSArray<NITRemoteItem *> * _Nonnull)items;
		[Export ("setItems:")]
		void SetItems (NITRemoteItem[] items);

		// -(void)removeRemoteItem:(NITRemoteItem * _Nonnull)item;
		[Export ("removeRemoteItem:")]
		void RemoveRemoteItem (NITRemoteItem item);

		// -(NSArray<NITRemoteItem *> * _Nonnull)getItems;
		[Export ("getItems")]
		// [Verify(MethodToProperty)]
		NITRemoteItem[] Items { get; }

		// -(NITRemoteItem * _Nullable)getMatchingItemFromEntry:(NITHistoryEntry * _Nonnull)entry;
		[Export ("getMatchingItemFromEntry:")]
		[return: NullAllowed]
		NITRemoteItem GetMatchingItemFromEntry (NITHistoryEntry entry);
	}
	...
	[BaseType (typeof(NSObject))]
	interface NITScheduleValidator : NITValidating
	{
		// -(instancetype _Nonnull)initWithDateManager:(NITDateManager * _Nonnull)dateManager;
		[Export ("initWithDateManager:")]
		IntPtr Constructor (NITDateManager dateManager);
	...
	interface NITUserProfile
	{
		...
		// -(void)getUserDataWithCompletionHandler:(void (^ _Nullable)(NSDictionary<NSString *,id> * _Nullable, NSError * _Nullable))handler;
		[Export ("getUserDataWithCompletionHandler:")]
		void GetUserDataWithCompletionHandler ([NullAllowed] Action<NSDictionary<NSString, NSObject>, NSError> handler);
	...
	// @interface NITUserProfileModel : NITResource <NSCoding>
	[BaseType (typeof(NITResource))]
	interface NITUserProfileModel : INSCoding
	{
		// @property (nonatomic, strong) NSArray<NITDataPoint *> * dataPoints;
		[Export ("dataPoints", ArgumentSemantic.Strong)]
		NITDataPoint[] DataPoints { get; set; }
	}
