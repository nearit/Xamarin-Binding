...
{
	[Native]
	public enum NITRegionEvent: long
	{
		EnterArea,
		LeaveArea,
		Immediate,
	...
	[Native]
	public enum NITBeaconNodeDepth: long
	{
		ProximityUUID = 1,
		Major = 2,
		MajorAndMinor = 3
	...
	[Native]
	public enum NITNetworkStatus: long
	{
		NotReachable = 0,
		ReachableViaWiFi,
		ReachableViaWWAN
	...
	[Native]
	public enum NITTreeLevelEvent: long
	{
		nter = 1,
		xit
	}
